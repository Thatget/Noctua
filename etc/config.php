...
return [
    'modules' => [
        ...
        'BL_FileAttributes' => 1,
        'Magento_Backend' => 1,
        'Emipro_MultilangCmsblock' => 0,
        'Emipro_MultilangCmspage' => 1,
        'Magento_Eav' => 1,
        'Magento_Customer' => 1,
        'Magento_Indexer' => 1,
        'Magento_Cms' => 1,
        ...
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Maghos_ProductViewLinks' => 1,
        'Mediarocks_ProSlider' => 1,
        'Meetanshi_DeferJS' => 1,
        'Onibi_StoreLocator' => 1,
        'SIT_AjaxFanSearch' => 1,
        'SIT_AjaxSearch' => 1,
        'SIT_BackendTheme' => 1,
        'SIT_BannerTab' => 1,
        'SIT_CatalogSearch' => 1,
        'SIT_Copyproductmeta' => 1,
        'SIT_CustomVariables' => 1,
        'SIT_Customfield' => 1,
        'SIT_GeneralNews' => 1,
        'SIT_GeneralTechnologiesNew' => 1,
        'SIT_Generatetechsitemap' => 1,
        'SIT_LanguageTranslator' => 1,
        'SIT_MainAdmin' => 1,
        'SIT_Mainpagevideo' => 1,
        'SIT_ProductCategoryFilter' => 1,
        'SIT_ProductCompatibility' => 1,
        'SIT_ProductFaqNew' => 1,
        'SIT_ProductReviewNew' => 1,
        'SIT_ProductTechNew' => 1,
        'SIT_ProductVideoNew' => 1,
        'SIT_TemplateText' => 1,
        'SIT_WebformApi' => 1,
        'Swissup_Easytabs' => 1,
        'Temando_Shipping' => 1,
        ...
        'VladimirPopov_WebFormsDepend' => 1,
