...
class InstallSchema implements InstallSchemaInterface {
	...
	public function install(SchemaSetupInterface $setup, ModuleContextInterface $context) {
		...
		$table = $installer->getConnection()
			...
			->addColumn('parent_tab', Table::TYPE_TEXT, 200, ['nullable' => true], 'Parent Tab')
			->addColumn('visible_tab', Table::TYPE_TEXT, 200, ['nullable' => true], 'Visible Tab')
			->addColumn('remove_from', Table::TYPE_TEXT, 200, ['nullable' => true], 'Remove From')
			->addColumn('visible_key', Table::TYPE_TEXT, 200, ['nullable' => true], 'Visible Key')
