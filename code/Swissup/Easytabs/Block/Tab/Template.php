...
class Template extends \Magento\Framework\View\Element\Template implements IdentityInterface
{
    ...
    protected function _toHtml()
    {
        ...
        if ($block instanceof \Magento\Framework\View\Element\Template) {
            $tabData = array("id" => $this->getTabId(), "alias" => $this->getAlias());
            return $block->setTemplate($this->getWidgetTemplate())->setData('tabdata', $tabData)
                ->toHtml();
        }
        return '';
    }
