    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'name' => 'description',
                'style' => 'height:20em;',
                'note' => __('This text will appear above the form'),
                'config' => $wysiwygConfig,
            ]
        );
        /*Changed by MD for Footer Description[START][25-04-2019]*/
        $fieldset->addField(
            'footer_description',
            'editor',
            [
                ...
                'style' => 'height:20em;',
                'note' => __('This text will appear below the form'),
                'config' => $wysiwygConfig,
            ]
        );
        /*Changed by MD for Footer Description[END][25-04-2019]*/
        $fieldset->addField(
            'success_text',
            'editor',
            [
