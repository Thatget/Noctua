...
class Slide extends AbstractModel implements IdentityInterface {
	 ...
	 * CMS page cache tag
	 */
	const CACHE_TAG = 'mediarocks_proslider_slide';
	 ...
	 * @var string
	 */
	protected $_cacheTag = 'mediarocks_proslider_slide';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'mediarocks_proslider_slide';
	...
	protected function _construct() {
		parent::_construct();
		$this->_init(\Mediarocks\ProSlider\Model\ResourceModel\Slide::class);
	}
