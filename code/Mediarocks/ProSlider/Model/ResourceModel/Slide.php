...
/**
 * Code standard by : Rh [23-3-2019]
 */

namespace Mediarocks\ProSlider\Model\ResourceModel;
...
class Slide extends AbstractEntity {
	...
	public function __construct(
		...
		$this->setType(ProsliderSlideSetup::ENTITY_TYPE_CODE_SL);
		$this->setConnection(ProsliderSlideSetup::ENTITY_TYPE_CODE_SL . '_read', ProsliderSlideSetup::ENTITY_TYPE_CODE_SL . '_write');
	...
	protected function _initCheckUrlKeySelect($urlKey, $store) {
		$connection = $this->getConnection();
		$urlRewrite = $this->_eavConfig->getAttribute(ProsliderSlideSetup::ENTITY_TYPE_CODE_SL, 'url_key');
