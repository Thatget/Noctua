...
namespace Mediarocks\ProSlider\Model\ResourceModel\Slider;
...
class Collection extends AbstractCollection {
	...
	protected function _construct() {
		$this->_init(\Mediarocks\ProSlider\Model\Slider::class, \Mediarocks\ProSlider\Model\ResourceModel\Slider::class);
	}
