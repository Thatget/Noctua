 ...
 */
namespace Mediarocks\ProSlider\Model\ResourceModel\Attribute\Slider;
...
class Collection extends EavCollection {
	...
	protected function _initSelect() {
		$this->getSelect()->from(
			...
			$this->_eavEntityFactory->create()->setType(ProsliderSliderSetup::ENTITY_TYPE_CODE)->getTypeId()
		)->join(
			['additional_table' => $this->getTable('mediarocks_proslider_slider_eav_attribute')],
