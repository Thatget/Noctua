...
class Slider extends AbstractEntity {
	...
	public function __construct(
		...
		$this->setType(ProsliderSliderSetup::ENTITY_TYPE_CODE);
		$this->setConnection(ProsliderSliderSetup::ENTITY_TYPE_CODE . '_read', ProsliderSliderSetup::ENTITY_TYPE_CODE . '_write');
	...
	protected function _initCheckUrlKeySelect($urlKey, $store) {
		$connection = $this->getConnection();
		$urlRewrite = $this->_eavConfig->getAttribute(ProsliderSliderSetup::ENTITY_TYPE_CODE, 'url_key');
