...
namespace Mediarocks\ProSlider\Model\ResourceModel\Eav\Slider;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface {
	 ...
	 * @var string
	 */
	protected $_eventPrefix = ProsliderSliderSetup::ENTITY_TYPE_CODE . '_entity_attribute';

	/**
	 * @return void
	 */
	protected function _construct() {
		$this->_init(\Mediarocks\ProSlider\Model\ResourceModel\SliderAttribute::class);
	}
