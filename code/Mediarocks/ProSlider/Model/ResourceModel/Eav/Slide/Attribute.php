...
namespace Mediarocks\ProSlider\Model\ResourceModel\Eav\Slide;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface {
	 ...
	 * Constants
	 */
	const MODULE_NAME = 'Mediarocks_ProSlider';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = ProsliderSlideSetup::ENTITY_TYPE_CODE_SL . '_entity_attribute';

	/**
	 * @return void
	 */
	protected function _construct() {
		$this->_init(\Mediarocks\ProSlider\Model\ResourceModel\SlideAttribute::class);
	}
