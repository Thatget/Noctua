...
namespace Mediarocks\ProSlider\Model\ResourceModel\Slide;
...
/**
 * Class Collection
 * @package Mediarocks\ProSlider\Model\ResourceModel\Slider
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Collection extends AbstractCollection {
	/**
	 * set slide title value
	 */
	const KEY_SLIDE_TITLE = 'title';

	/**
	 * set slide name value
	 */
	const KEY_SLIDE_NAME = 'slide_name';

	/**
	 * set slide image
	 */
	const KEY_SLIDE_IMAGE = 'image';

	/**
	 *set slide status
	 */
	const KEY_SLIDE_IS_ACTIVE = 'is_active';
	...
	protected function _construct() {
		$this->_init(\Mediarocks\ProSlider\Model\Slide::class, \Mediarocks\ProSlider\Model\ResourceModel\Slide::class);
	}
	...
	public function setTitle($title) {
		return $this->setData(self::KEY_SLIDE_TITLE, $title);
	}
	...
	public function getTitle() {
		return $this->getData(self::KEY_SLIDE_TITLE);
	}
	 ...
	 * @return $this
	 */
	public function setSlideName($slide_name) {
		return $this->setData(self::KEY_SLIDE_NAME, $slide_name);
	}
	...
	public function getSlideName() {
		return $this->getData(self::KEY_SLIDE_NAME);
	}
	...
	public function setImage($image) {
		return $this->setData(self::KEY_SLIDE_IMAGE, $image);
	}
	...
	public function getImage() {
		return $this->getData(self::KEY_SLIDE_IMAGE);
	}
	...
	public function setIsActive($status) {
		return $this->setData(self::KEY_SLIDE_IS_ACTIVE, $status);
	}
	...
	public function getIsActive() {
		return $this->getData(self::KEY_SLIDE_IS_ACTIVE);
	}
