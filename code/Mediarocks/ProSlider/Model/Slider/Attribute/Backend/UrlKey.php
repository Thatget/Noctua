 ...
 */
namespace Mediarocks\ProSlider\Model\Slider\Attribute\Backend;
...
class UrlKey extends AbstractBackend {
	...
	public function __construct(
		\Mediarocks\ProSlider\Model\ResourceModel\Slide $slider,
		Category $category
	) {
		$this->_slider = $slider;
	...
	public function beforeSave($object) {
		...
		$validKey = false;
		while (!$validKey) {
			$entityId = $this->_slider->checkUrlKey($urlKey, $object->getStoreId(), false);
