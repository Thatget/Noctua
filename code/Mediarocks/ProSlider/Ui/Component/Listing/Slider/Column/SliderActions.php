...
class SliderActions extends Column {
	 ...
	 * Url path
	 */
	const URL_PATH_EDIT = 'proslider/slider/edit';
	const URL_PATH_DELETE = 'proslider/slider/delete';
	...
	public function prepareDataSource(array $dataSource) {
		if (isset($dataSource['data']['items'])) {
			...
			$sliderCollection = $this->collectionFactory->create();
