...
use SIT\GeneralTechnologiesNew\Setup\EavTablesSetupFactory;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $tableName = GeneralTechnologySetup::ENTITY_TYPE_CODE;
        /**
         * Create entity Table
         */
        ...
        $table->addColumn(
            ...
            $setup->getFkName(
                'sit_generaltechnologiesnew_generaltechnologiesnew',
                'entity_type_id',
                'eav_entity_type',
                'entity_type_id'
            ),
        ...
        /** @var \SIT\GeneralTechnologiesNew\Setup\EavTablesSetup $eavTablesSetup */
        $eavTablesSetup = $this->eavTablesSetupFactory->create(['setup' => $setup]);
        $eavTablesSetup->createEavTables(GeneralTechnologySetup::ENTITY_TYPE_CODE);
