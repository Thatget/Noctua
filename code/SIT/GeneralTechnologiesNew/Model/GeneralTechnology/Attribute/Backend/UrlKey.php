 ...
 */
namespace SIT\GeneralTechnologiesNew\Model\GeneralTechnology\Attribute\Backend;
...
{
    /**
     * @var \SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology
     */
    protected $_generalTechnology;
     ...
     * @param \SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology $generalTechnology [description]
     * @param \Magento\Catalog\Model\Category           $category    [description]
     */
    public function __construct(
        \SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology $generalTechnology,
        \Magento\Catalog\Model\Category $category
    ) {
        $this->_generalTechnology = $generalTechnology;
    ...
    public function beforeSave($object)
    {
        ...
        if ($urlKey == '') {
            $urlKey = $object->getGenTechnologyTitle();
        }
        $urlKey = $this->formatUrlKey($urlKey);
        $validKey = false;
        while (!$validKey) {
            $entityId = $this->_generalTechnology->checkUrlKey($urlKey, $object->getStoreId(), false);
