 ...
 */
namespace SIT\GeneralTechnologiesNew\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\GeneralTechnologiesNew\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'SIT_GeneralTechnologiesNew';
     ...
     * @var string
     */
    protected $_eventPrefix = GeneralTechnologySetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\SIT\GeneralTechnologiesNew\Model\ResourceModel\Attribute::class);
    }
