 ...
 */
namespace SIT\GeneralTechnologiesNew\Model\ResourceModel;
...
class GeneralTechnology extends AbstractEntity {
	...
	public function __construct(
		...
		$this->setType(GeneralTechnologySetup::ENTITY_TYPE_CODE);
		$this->setConnection(GeneralTechnologySetup::ENTITY_TYPE_CODE . '_read', GeneralTechnologySetup::ENTITY_TYPE_CODE . '_write');
	...
	/**
	 * Retrieve GeneralTechnologiesNew entity default attributes
	 *
	 * @return string[]
	 */
	...
	protected function _initCheckUrlKeySelect($urlKey, $store) {
		$connection = $this->getConnection();
		$urlRewrite = $this->_eavConfig->getAttribute(GeneralTechnologySetup::ENTITY_TYPE_CODE, 'url_key');
