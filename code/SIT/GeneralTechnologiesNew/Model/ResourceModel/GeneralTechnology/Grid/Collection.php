 ...
 */
namespace SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology\Grid;
...
use SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology\Collection as GeneralTechnologyCollection;

/**
 * Class Collection
 * @package SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology\Grid
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Collection extends GeneralTechnologyCollection implements SearchResultInterface
{
    /**
    ...
    public function __construct(
        ...
        $eventObject,
        $resourceModel,
        $model = 'SIT\GeneralTechnologiesNew\Ui\Component\Listing\DataProvider\Document',
