 ...
 */
namespace SIT\GeneralTechnologiesNew\Model;

use Magento\Framework\DataObject\IdentityInterface;
use Magento\Framework\Model\AbstractModel;

class GeneralTechnology extends AbstractModel implements IdentityInterface {
	/**
	 * CMS page cache tag
	 */
	const CACHE_TAG = 'sit_generaltechnologiesnew_generaltechnology';
	 ...
	 * @var string
	 */
	protected $_cacheTag = 'sit_generaltechnologiesnew_generaltechnology';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'sit_generaltechnologiesnew_generaltechnology';
	...
	protected function _construct() {
		parent::_construct();
		$this->_init(\SIT\GeneralTechnologiesNew\Model\ResourceModel\GeneralTechnology::class);
	}
