...
class AssignProducts extends \Magento\Backend\Block\Template
{
     ...
     * @param \SIT\ProductVideoNew\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory [description]
    ...
    public function __construct(
        ...
        \SIT\ProductVideoNew\Model\ProductFactory $productFactory,
        array $data = []
    ) {
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                'SIT\ProductVideoNew\Block\Adminhtml\Tab\Productgrid',
    ...
    public function getProductsJson()
    {
        ...
        $productFactory->addFieldToFilter('productvideo_id', ['eq' => $entity_id]);
        $result = [];
        if (!empty($productFactory->getData())) {
            foreach ($productFactory->getData() as $videoProducts) {
                $result[$videoProducts['product_id']] = $videoProducts['position'];
            }
