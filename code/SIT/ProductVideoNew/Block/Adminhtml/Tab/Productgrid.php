...
use SIT\ProductVideoNew\Model\Product as ProductVideoModel;
...
class Productgrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param ProductVideoModel                                                         $productFaq     [description]
    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getRequest()->getParam("entity_id")) {
            $collection->joinField('position',
                ...
                'position',
                'product_id=entity_id',
                'productvideo_id=' . $this->getRequest()->getParam("entity_id"),
                'left');
        } else {
            $collection->joinField('position',
                'sit_productvideonew_productvideo_product',
    ...
    {
        return $this->getUrl('*/productvideo/grids', ['_current' => true]);
    }
    ...
    public function getSelectedProducts()
    {
        ...
        $model = $this->productFaq->getCollection()->addFieldToFilter('productvideo_id', $id);
        $grids = [];
