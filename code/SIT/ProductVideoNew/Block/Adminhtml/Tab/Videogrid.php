 ...
 */
namespace SIT\ProductVideoNew\Block\Adminhtml\Tab;
...
class Videogrid extends Extended
{
     ...
     * @param ProductVideoFactory     $productvideonewFactory [description]
    ...
    public function __construct(
        ...
        ProductVideoFactory $productvideonewFactory,
    ...
    {
        parent::_construct();
        $this->setId('productvideo_grid_products');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->_productvideonewFactory->create()->getCollection()->addAttributeToSelect('*');
        if ($entity_id) {
            $collection->joinField('position',
                'sit_productvideonew_productvideo_product',
                'position',
                'productvideo_id=entity_id',
        ...
        $this->addColumn(
            ...
            [
                ...
                'actions' => [
                    [
                        'caption' => __('Edit'),
                        'url' => ['base' => 'sit_productvideonew/productvideo/edit/'],
                        'field' => 'entity_id',
                        'target' => '_blank',
    ...
    {
        return $this->getUrl('sit_productvideonew/productvideo/videogrids', ['_current' => true]);
    }
    ...
    public function getSelectedVideo()
    {
        ...
        $collection = $tempSitVideoProduct->getCollection()->addFieldToSelect('productvideo_id')->addFieldToFilter("product_id", ["eq" => $entity_id]);
        $videoIds = [];
        foreach ($collection as $key => $value) {
            $videoIds[] = $value['productvideo_id'];
        }
        return $videoIds;
    }
}
