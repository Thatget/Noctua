 ...
 */
namespace SIT\ProductVideoNew\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\ProductVideoNew\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'SIT_ProductVideoNew';
     ...
     * @var string
     */
    protected $_eventPrefix = ProductVideoSetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\SIT\ProductVideoNew\Model\ResourceModel\Attribute::class);
    }
