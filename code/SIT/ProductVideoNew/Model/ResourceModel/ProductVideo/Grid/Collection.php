 ...
 */
namespace SIT\ProductVideoNew\Model\ResourceModel\ProductVideo\Grid;
...
use SIT\ProductVideoNew\Model\ResourceModel\ProductVideo\Collection as ProductVideoCollection;

/**
 * Class Collection
 * @package SIT\ProductVideoNew\Model\ResourceModel\ProductVideo\Grid
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Collection extends ProductVideoCollection implements SearchResultInterface {
	/**
	...
	public function __construct(
		...
		$eventObject,
		$resourceModel,
		$model = 'SIT\ProductVideoNew\Ui\Component\Listing\DataProvider\Document',
