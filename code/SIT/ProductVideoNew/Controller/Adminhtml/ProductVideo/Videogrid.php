...
class Videogrid extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        $resultLayout->getLayout()->getBlock('sit.productvideonew.tab.videogrid')->setProducts($this->getRequest()->getPost('products', null));
        return $resultLayout;
    }
}
