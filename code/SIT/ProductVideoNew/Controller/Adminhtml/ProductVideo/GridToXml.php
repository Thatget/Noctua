...
{
    /**
     * @var \SIT\ProductVideoNew\Model\ResourceModel\ProductVideo\CollectionFactory
     */
    ...
    public function execute()
    {
        ...
        $fileName = "Productvideo(" . date('Y-m-d') . ").xml";
        ...
        foreach ($exportBlock as $key => $value) {
            ...
            $csvData .= "<video_title><![CDATA[" . $value->getVideoTitle() . "]]></video_title>";
            $csvData .= "<status><![CDATA[" . $value->getStatus() . "]]></status>";
            $csvData .= "<video_link><![CDATA[" . $value->getVideoLink() . "]]></video_link>";
            $csvData .= "<video_reviewer_url><![CDATA[" . $value->getVideoReviewerUrl() . "]]></video_reviewer_url>";
            $csvData .= "<video_language><![CDATA[" . $options[$value->getVideoLanguage()]['label'] . "]]></video_language>";
            $csvData .= "</item>";
        }
        $csvData .= '</items>';
