 ...
 */
namespace SIT\TemplateText\Model\ResourceModel;
...
class TemplateText extends AbstractEntity {
	/**
	 * Store id
	 *
	 * @var int
	...
	public function __construct(
		...
		$this->setType(TemplateTextSetup::ENTITY_TYPE_CODE);
		$this->setConnection(TemplateTextSetup::ENTITY_TYPE_CODE . '_read', TemplateTextSetup::ENTITY_TYPE_CODE . '_write');
	...
	/**
	 * Retrieve TemplateText entity default attributes
	 *
	 * @return string[]
	 */
