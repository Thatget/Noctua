 ...
 */
namespace SIT\TemplateText\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\TemplateText\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'SIT_TemplateText';
     ...
     * @var string
     */
    protected $_eventPrefix = TemplateTextSetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\SIT\TemplateText\Model\ResourceModel\Attribute::class);
    }
