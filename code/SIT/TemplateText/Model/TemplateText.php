 ...
 */
namespace SIT\TemplateText\Model;

use Magento\Framework\DataObject\IdentityInterface;
use Magento\Framework\Model\AbstractModel;

class TemplateText extends AbstractModel implements IdentityInterface
{
    /**
     * CMS page cache tag
     */
    const CACHE_TAG = 'sit_templatetext_templatetext';
     ...
     * @var string
     */
    protected $_cacheTag = 'sit_templatetext_templatetext';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sit_templatetext_templatetext';
    ...
    {
        parent::_construct();
        $this->_init(\SIT\TemplateText\Model\ResourceModel\TemplateText::class);
    }
