...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (array_key_exists('comp_socket', $data)) {
            ...
            $this->_eventManager->dispatch(
                'sit_productcompatibility_coolers_prepare_save',
                ['object' => $this->productcompFactory, 'request' => $this->getRequest()]
            );

            try {
                $productcompInstance->save();
                if (isset($data['productcompatibility_coolers_products'])
                    && is_string($data['productcompatibility_coolers_products'])) {
                    $productsId = (array) json_decode($data['productcompatibility_coolers_products']);
