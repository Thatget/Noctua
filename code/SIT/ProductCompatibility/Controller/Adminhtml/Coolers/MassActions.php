...
class MassActions extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('SIT_ProductCompatibility::casecoolers');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Case / Coolers Compatibility MassActions'));
        return $resultPage;
    }
}
