    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->_eventManager->dispatch(
                'sit_productcompatibility_fans_prepare_save',
                ['object' => $this->productcompFactory, 'request' => $this->getRequest()]
            );

            try {
                $productcompInstance->save();
                if (isset($data['productcompatibility_fans_products'])
                    && is_string($data['productcompatibility_fans_products'])) {
                    $productsId = (array) json_decode($data['productcompatibility_fans_products']);
