...
class Cpuduplicate extends Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('SIT_ProductCompatibility::cpu');
        $resultPage->getConfig()->getTitle()->prepend(__('Duplicate Compatibility CPU'));
        return $resultPage;
    }
}
