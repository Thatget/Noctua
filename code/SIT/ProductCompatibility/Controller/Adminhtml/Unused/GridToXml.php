...
class GridToXml extends Action
{
    ...
    public function execute()
    {
        ...
        $fileName = "ProductCompatibility_" . $this->coreSession->getProCompType() . "(" . date('Y-m-d') . ").xml";
        ...
        $optionId = $this->prodCompHelper->getAttrOptionId($modelAllOption, trim($this->coreSession->getProCompType()));
        ...
        foreach ($exportBlock as $key => $value) {
            ...
            $csvData .= "<comp_socket><![CDATA[" . $socketValue . "]]></comp_socket>";
            $csvData .= "<comp_manufacture><![CDATA[" . $manufacturerValue . "]]></comp_manufacture>";
            $csvData .= "<comp_model><![CDATA[" . $modelValue . "]]></comp_model>";
            $csvData .= "<comp_value><![CDATA[" . $compValue . "]]></comp_value>";
            $csvData .= "<status><![CDATA[" . $status . "]]></status>";
            $csvData .= "<product_name><![CDATA[" . $value->getPname() . "]]></product_name>";
            $csvData .= "<template_text><![CDATA[" . $tempName . "]]></template_text>";
            $csvData .= "</item>";
        }
        $csvData .= '</items>';
