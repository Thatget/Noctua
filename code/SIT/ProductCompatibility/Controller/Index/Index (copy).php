...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $rs_default = $read->fetchAll("SELECT * FROM " . $default_table . " WHERE extra_comment IS NOT NULL ORDER BY comp_id");
        echo "<pre>";
        $comp_id_arr = [];
        $count = 0;
        ...
        $arr2 = [2681,
            ...
            12621,
            12623];
        print_r(array_diff($comp_id, $arr2));
        exit();
    }

    protected function cmp($a, $b)
    {
        return strcmp($a["comp_id"], $b["comp_id"]);
    }
}
