 ...
 */
namespace SIT\ProductCompatibility\Ui\Component\Listing\Coolers;
...
class DataProvider extends UiDataProvider
{
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult)
    {
         ...
         */
        /**
         * Changed by MD for get Case Coolers Compatibility Collection[START][30-05-2019]
         */
        $searchResult->getSelect()->joinLeft(
        ...
        /**
         * Changed by MD for get Case Coolers Compatibility Collection[END][30-05-2019]
         */
        /**
         * Changed by MD for Unused Compatibility[START][23-05-2019]
         */
        $unusedComp = $this->request->getParam('unused');
        if ($unusedComp == 'unusedcoolers') {
