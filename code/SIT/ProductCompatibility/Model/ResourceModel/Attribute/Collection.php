 ...
 */
namespace SIT\ProductCompatibility\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection {
	...
	protected function _initSelect() {
		$this->getSelect()->from(
			...
			$this->_eavEntityFactory->create()->setType(ProductCompatibilitySetup::ENTITY_TYPE_CODE)->getTypeId()
		)->join(
			['additional_table' => $this->getTable(ProductCompatibilitySetup::EAV_ENTITY_TYPE_CODE . '_eav_attribute')],
