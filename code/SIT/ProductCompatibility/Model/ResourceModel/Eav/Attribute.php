 ...
 */
namespace SIT\ProductCompatibility\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\ProductCompatibility\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface {
	/**
	 * Constants
	 */
	const MODULE_NAME = 'SIT_ProductCompatibility';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = ProductCompatibilitySetup::ENTITY_TYPE_CODE . '_attribute';
	...
	protected function _construct() {
		...
		$this->_init(\SIT\ProductCompatibility\Model\ResourceModel\Attribute::class);
	}
