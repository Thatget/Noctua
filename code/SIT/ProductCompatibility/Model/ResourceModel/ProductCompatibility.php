...
class ProductCompatibility extends AbstractEntity {
	/**
	 * Store id
	 *
	 * @var int
	...
	public function __construct(
		...
		$this->setType(ProductCompatibilitySetup::ENTITY_TYPE_CODE);
		$this->setConnection(ProductCompatibilitySetup::ENTITY_TYPE_CODE . '_read', ProductCompatibilitySetup::ENTITY_TYPE_CODE . '_write');
