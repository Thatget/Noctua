 ...
 */
namespace SIT\ProductCompatibility\Block\Adminhtml\CPU;
...
class AssignProducts extends \Magento\Backend\Block\Template {
	 ...
	 * @var string
	 */
	protected $_template = 'products/cpu/assign_products.phtml';
	...
	public function getBlockGrid() {
		if (null === $this->blockGrid) {
			$this->blockGrid = $this->getLayout()->createBlock(
				'SIT\ProductCompatibility\Block\Adminhtml\CPU\Tab\Productgrid',
				'sit.productcompatibility.cpu.tab.productgrid'
			);
		}
