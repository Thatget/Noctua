...
class CompType extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
    ...
    {
        $manuInfo = $this->prodCompHelper->getAttributeInfo(ProductCompHelper::COMP_EAV_TYPE, ProductCompHelper::COMP_TYPE);
        ...
        if (array_key_exists($row->getCompType(), $manuArr)) {
            return $manuArr[$row->getCompType()];
        }
    }
}
