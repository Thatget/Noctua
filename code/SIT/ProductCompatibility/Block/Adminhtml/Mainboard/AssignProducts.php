 ...
 */
namespace SIT\ProductCompatibility\Block\Adminhtml\Mainboard;
...
class AssignProducts extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'products/mainboard/assign_products.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                'SIT\ProductCompatibility\Block\Adminhtml\Mainboard\Tab\Productgrid',
                'sit.productcompatibility.mainboard.tab.productgrid'
            );
        }
