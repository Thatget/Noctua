 ...
 */
namespace SIT\ProductCompatibility\Block\Adminhtml\Fans;
...
class AssignProducts extends \Magento\Backend\Block\Template {
	 ...
	 * @var string
	 */
	protected $_template = 'products/fans/assign_products.phtml';
	...
	public function getBlockGrid() {
		if (null === $this->blockGrid) {
			$this->blockGrid = $this->getLayout()->createBlock(
				'SIT\ProductCompatibility\Block\Adminhtml\Fans\Tab\Productgrid',
				'sit.productcompatibility.fans.tab.productgrid'
			);
		}
