...
class Faqgrid extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        $resultLayout->getLayout()->getBlock('sit.productfaqnew.tab.faqgrid')->setProducts($this->getRequest()->getPost('products', null));
        return $resultLayout;
    }
}
