...
class AssignProducts extends \Magento\Backend\Block\Template {
	 ...
	 * @param \SIT\ProductFaqNew\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory [description]
	...
	public function __construct(
		...
		\SIT\ProductFaqNew\Model\ProductFactory $productFactory,
		array $data = []
	) {
	...
	public function getBlockGrid() {
		if (null === $this->blockGrid) {
			$this->blockGrid = $this->getLayout()->createBlock(
				'SIT\ProductFaqNew\Block\Adminhtml\Tab\Productgrid',
	...
	public function getProductsJson() {
		...
		$productFactory->addFieldToFilter('productfaq_id', ['eq' => $entity_id]);
		$result = [];
