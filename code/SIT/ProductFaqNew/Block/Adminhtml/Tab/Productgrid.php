...
use SIT\ProductFaqNew\Model\Product as ProductFaqModel;
...
class Productgrid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param ProductFaqModel                                                         $productFaq     [description]
    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getRequest()->getParam("entity_id")) {
            $collection->joinField('position',
                ...
                'position',
                'product_id=entity_id',
                'productfaq_id=' . $this->getRequest()->getParam("entity_id"),
                'left');
        } else {
            $collection->joinField('position',
                'sit_productfaqnew_productfaq_product',
    ...
    {
        return $this->getUrl('*/productfaq/grids', ['_current' => true]);
    }
    ...
    public function getSelectedProducts()
    {
        ...
        $model = $this->productFaq->getCollection()->addFieldToFilter('productfaq_id', $id);
        $grids = [];
