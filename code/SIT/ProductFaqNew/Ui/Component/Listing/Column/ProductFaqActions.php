...
class ProductFaqActions extends Column
{
     ...
     * Url path
     */
    const URL_PATH_EDIT = 'sit_productfaqnew/productfaq/edit';
    const URL_PATH_DELETE = 'sit_productfaqnew/productfaq/delete';
    const URL_PATH_DUPLICATE = 'sit_productfaqnew/productfaq/duplicate';
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['entity_id'])) {
                    ...
                    $item[$this->getData('name')]['delete'] = [
                        ...
                        'label' => __('Delete'),
                        'confirm' => [
                            'title' => __('Delete ' . $item['faq_que']),
                            'message' => __('Are you sure you wan\'t to delete a ' . $item['faq_que'] . ' record?'),
                        ],
                        'hidden' => false,
                    ];
