 ...
 */
namespace SIT\ProductFaqNew\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(ProductFaqSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(ProductFaqSetup::EAV_ENTITY_TYPE_CODE . '_eav_attribute')],
