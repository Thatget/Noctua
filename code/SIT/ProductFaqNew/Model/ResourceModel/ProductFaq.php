...
class ProductFaq extends AbstractEntity {
	/**
	 * Store id
	 *
	 * @var int
	...
	public function __construct(
		...
		$this->setType(ProductFaqSetup::ENTITY_TYPE_CODE);
		$this->setConnection(ProductFaqSetup::ENTITY_TYPE_CODE . '_read', ProductFaqSetup::ENTITY_TYPE_CODE . '_write');
