 ...
 */
namespace SIT\ProductFaqNew\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\ProductFaqNew\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'SIT_ProductFaqNew';
     ...
     * @var string
     */
    protected $_eventPrefix = ProductFaqSetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\SIT\ProductFaqNew\Model\ResourceModel\Attribute::class);
    }
