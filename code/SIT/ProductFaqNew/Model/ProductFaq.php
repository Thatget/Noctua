...
class ProductFaq extends AbstractModel implements IdentityInterface
{
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'sit_productfaqnew_productfaq';
     ...
     * @var string
     */
    protected $_cacheTag = 'sit_productfaqnew_productfaq';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sit_productfaqnew_productfaqnew';
    ...
    {
        parent::_construct();
        $this->_init(\SIT\ProductFaqNew\Model\ResourceModel\ProductFaq::class);
    }
