...
class Reviewgrid extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        $resultLayout->getLayout()->getBlock('sit.productreviewnew.tab.reviewgrid')->setProducts($this->getRequest()->getPost('products', null));
        return $resultLayout;
    }
}
