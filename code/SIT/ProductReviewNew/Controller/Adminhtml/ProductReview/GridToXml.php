...
class GridToXml extends Action
{
    ...
    public function execute()
    {
        ...
        $fileName = "Productreview(" . date('Y-m-d') . ").xml";
        ...
        foreach ($exportBlock as $key => $value) {
            ...
            $csvData .= "<pname><![CDATA[" . $value->getPname() . "]]></pname>";
            $csvData .= "<product_review_priority><![CDATA[" . $value->getProductReviewPriority() . "]]></product_review_priority>";
            $csvData .= "<review_position><![CDATA[" . $value->getReviewPosition() . "]]></review_position>";
            $csvData .= "<review_website><![CDATA[" . $value->getReviewWebsite() . "]]></review_website>";
            $csvData .= "<r_lng><![CDATA[" . $value->getRLng() . "]]></r_lng>";
            $csvData .= "<review_country><![CDATA[" . $value->getReviewCountry() . "]]></review_country>";
            $csvData .= "<review_startpage><![CDATA[" . $value->getReviewStartpage() . "]]></review_startpage>";
            $csvData .= "<created_at><![CDATA[" . $value->getCreatedAt() . "]]></created_at>";
            $csvData .= "</item>";
        }
        $csvData .= '</items>';
