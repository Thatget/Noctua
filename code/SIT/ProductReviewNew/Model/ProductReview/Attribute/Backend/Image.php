 ...
 */
namespace SIT\ProductReviewNew\Model\ProductReview\Attribute\Backend;
...
class Image extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend {
	...
	public function beforeSave($object) {
		...
		/**
		 * Set null value of image when image delete : Rh [19-3-2019]
		 */
		$review_image = $object->getReviewImage();
		if (is_array($review_image)) {
			...
			$object->setData($attributeName, $review_image);
