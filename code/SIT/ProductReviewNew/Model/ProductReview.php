...
class ProductReview extends AbstractModel implements IdentityInterface {
	 ...
	 * CMS page cache tag
	 */
	const CACHE_TAG = 'sit_productreviewnew_productreview';
	 ...
	 * @var string
	 */
	protected $_cacheTag = 'sit_productreviewnew_productreview';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'sit_productreviewnew_productreview';
	...
	protected function _construct() {
		parent::_construct();
		$this->_init(\SIT\ProductReviewNew\Model\ResourceModel\ProductReview::class);
	}
