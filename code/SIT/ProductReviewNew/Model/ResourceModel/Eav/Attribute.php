 ...
 */
namespace SIT\ProductReviewNew\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\ProductReviewNew\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface {
	/**
	 * Constants
	 */
	const MODULE_NAME = 'SIT_ProductReviewNew';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = ProductReviewSetup::ENTITY_TYPE_CODE . '_attribute';
	...
	protected function _construct() {
		...
		$this->_init(\SIT\ProductReviewNew\Model\ResourceModel\Attribute::class);
	}
