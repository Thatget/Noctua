...
class ProductReview extends AbstractEntity {
	...
	public function __construct(
		...
		$this->setType(ProductReviewSetup::ENTITY_TYPE_CODE);
		$this->setConnection(ProductReviewSetup::ENTITY_TYPE_CODE . '_read', ProductReviewSetup::ENTITY_TYPE_CODE . '_write');
