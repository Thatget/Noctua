 ...
 */
namespace SIT\GeneralNews\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\GeneralNews\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface {
	/**
	 * Constants
	 */
	const MODULE_NAME = 'SIT_GeneralNews';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = NewsSetup::ENTITY_TYPE_CODE . '_attribute';
	...
	protected function _construct() {
		...
		$this->_init(\SIT\GeneralNews\Model\ResourceModel\Attribute::class);
	}
