 ...
 */
namespace SIT\GeneralNews\Model;
...
class News extends AbstractModel implements IdentityInterface {
	 ...
	 * CMS page cache tag
	 */
	const CACHE_TAG = 'sit_generalnews_news';
	 ...
	 * @var string
	 */
	protected $_cacheTag = 'sit_generalnews_news';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'sit_generalnews_news';
	...
	protected function _construct() {
		parent::_construct();
		$this->_init(\SIT\GeneralNews\Model\ResourceModel\News::class);
	}
