...
use SIT\GeneralNews\Setup\EavTablesSetupFactory;
...
class InstallSchema implements InstallSchemaInterface {
...

	{
		...
		$tableName = NewsSetup::ENTITY_TYPE_CODE;
		/**
		 * Create entity Table
		 */
		...
		/** @var \SIT\GeneralNews\Setup\EavTablesSetup $eavTablesSetup */
		$eavTablesSetup = $this->eavTablesSetupFactory->create(['setup' => $setup]);
		$eavTablesSetup->createEavTables(NewsSetup::ENTITY_TYPE_CODE);
