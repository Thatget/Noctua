 ...
 */
namespace SIT\Mainpagevideo\Model\ResourceModel;
...
class Mainpagevideo extends AbstractEntity {
	/**
	 * Store id
	 *
	 * @var int
	...
	public function __construct(
		...
		$this->setType(MainpagevideoSetup::ENTITY_TYPE_CODE);
		$this->setConnection(MainpagevideoSetup::ENTITY_TYPE_CODE . '_read', MainpagevideoSetup::ENTITY_TYPE_CODE . '_write');
	...
	/**
	 * Retrieve Mainpagevideo entity default attributes
	 *
	 * @return string[]
	 */
