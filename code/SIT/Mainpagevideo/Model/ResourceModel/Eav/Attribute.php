 ...
 */
namespace SIT\Mainpagevideo\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\Mainpagevideo\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'SIT_Mainpagevideo';
     ...
     * @var string
     */
    protected $_eventPrefix = MainpagevideoSetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\SIT\Mainpagevideo\Model\ResourceModel\Attribute::class);
    }
