 ...
 */
namespace SIT\Mainpagevideo\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(MainpagevideoSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(MainpagevideoSetup::EAV_ENTITY_TYPE_CODE . '_eav_attribute')],
