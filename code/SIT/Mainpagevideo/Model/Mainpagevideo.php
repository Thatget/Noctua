 ...
 */
namespace SIT\Mainpagevideo\Model;

use Magento\Framework\DataObject\IdentityInterface;
use Magento\Framework\Model\AbstractModel;

class Mainpagevideo extends AbstractModel implements IdentityInterface
{
    /**
     * CMS page cache tag
     */
    const CACHE_TAG = 'sit_mainpagevideo_mainpagevideo';
     ...
     * @var string
     */
    protected $_cacheTag = 'sit_mainpagevideo_mainpagevideo';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sit_mainpagevideo_mainpagevideo';
    ...
    {
        parent::_construct();
        $this->_init(\SIT\Mainpagevideo\Model\ResourceModel\Mainpagevideo::class);
    }
