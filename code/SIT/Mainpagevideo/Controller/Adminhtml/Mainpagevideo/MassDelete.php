...
class MassDelete extends Action
{
     ...
     */
    public function __construct(Context $context, Filter $filter, Collection $mainpagevideoCollection)
    {
        $this->filter = $filter;
    ...
    {
        $collection = $this->filter->getCollection($this->_mainpagevideoCollection);
