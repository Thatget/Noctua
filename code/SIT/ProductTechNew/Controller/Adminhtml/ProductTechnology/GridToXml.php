...
class GridToXml extends Action
{
    ...
    public function execute()
    {
        ...
        $fileName = "ProductTechnologies(" . date('Y-m-d') . ").xml";
        ...
        foreach ($exportBlock as $key => $value) {
            ...
            $csvData .= "<product_technology_title><![CDATA[" . $value->getTechnologyTitle() . "]]></product_technology_title>";
            $csvData .= "<product_technology_description><![CDATA[" . $value->getTechnologyShortdesc() . "]]></product_technology_description>";
