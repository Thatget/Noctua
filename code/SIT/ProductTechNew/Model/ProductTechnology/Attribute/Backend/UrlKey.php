...
{
    /**
     * @var \SIT\ProductTechNew\Model\ResourceModel\ProductTechnology
     */
    protected $_productTechnology;
     ...
     * @param \SIT\ProductTechNew\Model\ResourceModel\ProductTechnology $productTechnology [description]
     * @param \Magento\Catalog\Model\Category           $category    [description]
     */
    public function __construct(
        \SIT\ProductTechNew\Model\ResourceModel\ProductTechnology $productTechnology,
        \Magento\Catalog\Model\Category $category
    ) {
        $this->_productTechnology = $productTechnology;
    ...
    public function beforeSave($object)
    {
        ...
        if ($urlKey == '') {
            $urlKey = $object->getTechnologyTitle();
        }
        $urlKey = $this->formatUrlKey($urlKey);
        $validKey = false;
        while (!$validKey) {
            $entityId = $this->_productTechnology->checkUrlKey($urlKey, $object->getStoreId(), false);
