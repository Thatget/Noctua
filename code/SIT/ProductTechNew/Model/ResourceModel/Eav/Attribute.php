 ...
 */
namespace SIT\ProductTechNew\Model\ResourceModel\Eav;
...
/**
 * Class Attribute
 * @package SIT\ProductTechNew\Model\ResourceModel\Eav
 */
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'SIT_ProductTechNew';
     ...
     * @var string
     */
    protected $_eventPrefix = ProductTechnologySetup::ENTITY_TYPE_CODE . '_attribute';
    ...
    protected function _construct()
    {
        ...
        $this->_init(\SIT\ProductTechNew\Model\ResourceModel\Attribute::class);
    }
