...
class ProductTechnology extends AbstractEntity {
	...
	public function __construct(
		...
		$this->setType(ProductTechnologySetup::ENTITY_TYPE_CODE);
		$this->setConnection(ProductTechnologySetup::ENTITY_TYPE_CODE . '_read', ProductTechnologySetup::ENTITY_TYPE_CODE . '_write');
	...
	/**
	 * Retrieve ProductTechNew entity default attributes
	 *
	 * @return string[]
	 */
	...
	protected function _initCheckUrlKeySelect($urlKey, $store) {
		$connection = $this->getConnection();
		$urlRewrite = $this->_eavConfig->getAttribute(ProductTechnologySetup::ENTITY_TYPE_CODE, 'url_key');
