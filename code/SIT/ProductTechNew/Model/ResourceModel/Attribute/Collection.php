 ...
 */
namespace SIT\ProductTechNew\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(ProductTechnologySetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(ProductTechnologySetup::EAV_ENTITY_TYPE_CODE . '_eav_attribute')],
