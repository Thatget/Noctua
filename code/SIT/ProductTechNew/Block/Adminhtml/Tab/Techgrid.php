...
class Techgrid extends Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productTechnologyFactory->create()->getCollection()->addAttributeToSelect('*');
        if ($entity_id) {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'technology_shortdesc',
            [
                'header' => __('Description'),
                'index' => 'technology_shortdesc',
                'header_css_class' => 'col-type',
                'column_css_class' => 'col-type',
                'renderer' => 'SIT\ProductTechNew\Block\Adminhtml\Tab\Renderer\Description',
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'actions' => [
                    [
                        'caption' => __('Edit'),
                        'url' => ['base' => 'sit_producttechnew/producttechnology/edit/'],
                        'field' => 'entity_id',
                        'target' => '_blank',
    ...
    {
        return $this->getUrl('sit_producttechnew/producttechnology/techgrids', ['_current' => true]);
    }
     ...
     * @return array
     */
    public function getSelectedTech()
    {
        $entity_id = $this->getRequest()->getParam('id');
        $tempSitTechProduct = $this->sitTechProduct;
        $collection = $tempSitTechProduct->getCollection()->addFieldToSelect('producttechnology_id')->addFieldToFilter("product_id", ["eq" => $entity_id]);
        $techIds = [];
        foreach ($collection as $key => $value) {
            $techIds[] = $value['producttechnology_id'];
        }
        return $techIds;
    }
}
